---
description: "Implementation plan template for feature development (no tests)"
scripts:
...
**Testing**: [None - development without tests]
...
- Load `.specify/templates/tasks-template-no-tests.md` as base
- Generate tasks from Phase 1 design docs (contracts, data model, quickstart)
- Each entity → model creation task [P]
- Each user story → implementation task
- Implementation tasks to build working system
